...
var extensionURL = 'https://www-staging.rit.edu/its/sisextension/SIS/sismod.user.js';
var firefoxExtensionURL = 'https://www-staging.rit.edu/its/sisextension/downloads/rit_sis_extension-1.0.0-fx.xpi';
var safariExtensionURL = 'https://www-staging.rit.edu/its/sisextension/downloads/RIT%20SIS%20Extension.safariextz';
var chromeExtensionURL = 'https://www-staging.rit.edu/its/sisextension/downloads/chrome_extension.crx';
var browse;
...
function replaceElementWithChrome(eid) {
	...
	element.innerHTML = 
		...
		'<ol>' +
			...
			'<li><p>Locate the extension file ("sismod.user.js") on your computer and drag the file onto the Extensions page.</li>' +
